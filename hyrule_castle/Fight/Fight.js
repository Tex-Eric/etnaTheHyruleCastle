...
var Vilain_1 = require("../JSData/Vilain");
var nombreAleatoire = function () { return Math.floor(Math.random() * 3); };
var Fight = function (heroName, heroPVCurrent, heroPVTotal, heroAtt) {
    var vilainIndex = nombreAleatoire();
    var vilainName = Vilain_1.default[vilainIndex].nom;
    var vilainPVCurrent = Vilain_1.default[vilainIndex].PV;
    var vilainPVTotal = Vilain_1.default[vilainIndex].PV;
    var vilainAtt = Vilain_1.default[vilainIndex].Att;
    var VilainImage = Vilain_1.default[vilainIndex].image;
    var textN = "\n";
